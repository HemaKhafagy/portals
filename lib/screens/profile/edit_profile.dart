...
class EditProfile extends StatelessWidget {
      ...
      builder: (context,state){
        ...
        return Scaffold(
          body: Container(
            ...
            child: homeTapsCubitAccess.updateUserDataIsLoading ? Center(child: CircularProgressIndicator(),) :
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text("Edit Profile",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700),),
                      InkWell(
                  ...
                  Column(
                    children: [
                      buildSharedButton(buttonName: "Save Changes", isEnabled: true, action: (){
  ...
  Widget buildDropDownButton(BuildContext context,double screenWidth,TextEditingController controller) => Container(
    ...
    child: Column(
      children: [
        ...
        Text("Country",style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w700),),
  ...
  Widget buildCityFiled(BuildContext context,double screenWidth) => Container(
    ...
    child: Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Flexible(child: Text("Country",style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w700),overflow: TextOverflow.ellipsis,)),
        Icon(FontAwesomeIcons.arrowDown)
      ],
    ),
  );

  Widget buildPageTextFormFiled(
      TextEditingController controller,
      String hintText,
      String labelText,
      bool multiLine,
      var validator) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      SizedBox(
