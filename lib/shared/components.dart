      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: isEnabled
                ? <Color>[const Color(0xfff24998), const Color(0xfff2845c)]
                : <Color>[
            ...
            child: InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: name == "portal" && path != null
                          ? const Color.fromRGBO(242, 132, 92, 1)
                          : Colors.white,
                      width: 2),
...
Widget buildSharedImageFromNetwork(String url,
